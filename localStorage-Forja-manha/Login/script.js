// função de login
function login(){
    //logica que conectará com o localstorage
...
function fecharError(){
        ...
        document.getElementById("nome").style.borderBottom = "2px solid #00fff2ff"
        document.getElementById("senha").style.borderBottom = "2px solid #00fff2ff"  
}